    ...
    try {
      ...
      setState(() {
        ...
        if (vehicles.isNotEmpty && vehicles[0]['vehicleId'] != null) {
          ...
          typeController.text = "Vehicle Registration - ${vehicles[0]['plateNo'] ?? ''}";
        }
      });
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text("New Document", style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700, color: Colors.white)),
        leading: IconButton(
        ...
        child: Column(
          ...
          children: [
            ...
            vehicles.isEmpty
              ...
              value: vehicles.any((v) => v['vehicleId'] == selectedVehicleId)
                  ? selectedVehicleId
                  : null,
