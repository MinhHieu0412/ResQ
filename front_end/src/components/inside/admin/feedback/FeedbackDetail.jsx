const FeedbackDetail = ({feedback}) => {
    return (<table className="w-full border border-separate border-spacing-0 border-[#D8D8D8] rounded-2xl">
        <tr>
            ...
            <td className="font-lexend feedbackContent">
                <div className="flex flex-row items-center gap-1">
                    {feedback.rateRequest > 0 ? (
                        ...
                        <span className="text-gray-400 italic">-</span> // hoặc "Chưa đánh giá"
                    )}
                </div>
            </td>
        </tr>
