...
//    private String liveUrl;
    ...
    // Get Payout Status
    public JsonNode getPayoutStatus(String payoutBatchId) throws Exception {
        String token = getAccessToken(sandboxId,sandboxSecret,sandboxUrl); // Hàm lấy access token của bạn
