    ...
    Swal.fire({
      ...
      html: `
        <div class="p-4">
          ...
          <div class="mb-4 flex items-center">
            <label class="block text-sm font-bold mr-2 w-1/4">Last Updated:</label>
            <input id="updated_at" class="swal2-input w-full text-xs p-2" value="${
      ...
      <table className="min-w-full border border-gray-200 rounded overflow-hidden shadow-sm mt-4">
        <thead className="bg-blue-400 text-white">
          <tr>
            ...
            <th className="px-4 py-2 text-left">Fixed Price</th>
        ...
        <tbody className="bg-white">
          {services.map((service, idx) => (
            ...
            >
              ...
              <td className="px-4 py-2">{service.createdAt}</td>
              <td className="px-4 py-2">{service.updatedAt}</td>
              <td className="px-4 py-2 space-x-2">
                ...
                <button
                  ...
                  className="border border-blue-500 text-blue-500 hover:bg-blue-100 px-2 py-1 rounded-full"
                >
                  ✏️ Edit
                </button>
              </td>
